...
import net.yeoxuhang.chorus_lib.api.biome.BiomeSelectionContext;
import net.yeoxuhang.chorus_lib.api.biome.ModificationPhase;
...
public class BiomeModificationImpl {
    ...
    public void finalizeWorldGen(RegistryAccess impl, PrimaryLevelData levelProperties) {
        ...
        for (ResourceKey<Biome> key : keys) {
            ...
            BiomeSelectionContext context = (BiomeSelectionContext) new BiomeSelectionContextImpl(impl, levelProperties, key, biome);
