package net.yeoxuhang.chorus_lib.impl.biome.modification;
...
import net.yeoxuhang.chorus_lib.api.biome.BiomeModificationContext;
...
public class BiomeModificationContextImpl implements BiomeModificationContext {
    ...
    private class SpawnSettingsContextImpl implements SpawnSettingsContext {
        ...
        private final EnumMap<MobCategory, List<MobSpawnSettings.SpawnerData>> chorus_libSpawners = new EnumMap<>(MobCategory.class);
        ...
        private void unfreezeSpawners() {
            ...
            for (MobCategory spawnGroup : MobCategory.values()) {
                ...
                if (entries != null) {
                    chorus_libSpawners.put(spawnGroup, new ArrayList<>(entries.unwrap()));
                } else {
                    chorus_libSpawners.put(spawnGroup, new ArrayList<>());
                }
            }
        }
        ...
        private void freezeSpawners() {
            ...
            for (Map.Entry<MobCategory, List<MobSpawnSettings.SpawnerData>> entry : chorus_libSpawners.entrySet()) {
        ...
        public void addSpawn(MobCategory spawnGroup, MobSpawnSettings.SpawnerData spawnEntry) {
            ...
            chorus_libSpawners.get(spawnGroup).add(spawnEntry);
        }
        ...
        public boolean removeSpawns(BiPredicate<MobCategory, MobSpawnSettings.SpawnerData> predicate) {
            ...
            for (MobCategory group : MobCategory.values()) {
                if (chorus_libSpawners.get(group).removeIf(entry -> predicate.test(group, entry))) {
                    anyRemoved = true;
                }
            }
