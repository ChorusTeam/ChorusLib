...
public final class NetherBiomeData {
    ...
    public static void modifyBiomeSource(Registry<Biome> biomeRegistry, BiomeSource biomeSource) {
        /*if (biomeSource instanceof MultiNoiseBiomeSource multiNoiseBiomeSource) {
            if (((BiomeSourceAccess) multiNoiseBiomeSource).shouldModifyBiomeEntries() && multiNoiseBiomeSource.stable(MultiNoiseBiomeSource.Preset.NETHER)) {
                multiNoiseBiomeSource.parameters = NetherBiomeData.withModdedBiomeEntries(
                ...
                ((BiomeSourceAccess) multiNoiseBiomeSource).setModifyBiomeEntries(false);
            }
        }*/
        if (biomeSource instanceof MultiNoiseBiomeSource multiNoiseBiomeSource) {
            if (((BiomeSourceAccess) multiNoiseBiomeSource).shouldModifyBiomeEntries() && multiNoiseBiomeSource.stable(MultiNoiseBiomeSource.Preset.NETHER)) {
